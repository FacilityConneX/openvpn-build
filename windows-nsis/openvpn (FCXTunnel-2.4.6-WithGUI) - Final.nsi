...
Section -post
	...
	WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\${PACKAGE_NAME0}" "HelpLink" "https://facilityconnex.com"
	...
	WriteRegStr HKLM "SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\${PACKAGE_NAME0}" "URLInfoAbout" "https://facilityconnex.com"
